...
CREATE
TYPE category AS ENUM ('OBUWIE', 'UBRANIA', 'SAMOCHODY', 'NIERUCHOMOSCI', 'ZABAWKI', 'INNE');
CREATE
TYPE offer_type AS ENUM ('KUP_TERAZ', 'LICYTACJA', 'OGLOSZENIE');
CREATE
TYPE shipment_type AS ENUM ('KURIER', 'POCZTA', 'PACZKOMAT', 'ODBIOR_OSOBISTY');
CREATE
TYPE stage AS ENUM ('PUSTY', 'ZAPELNIONY', 'PLATNOSC');
CREATE
TYPE payment_method AS ENUM ('CREDIT', 'CARD');
